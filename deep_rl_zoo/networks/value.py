...
class Agent57FCNet(nn.Module):
    """Agent57 DQN FC network."""
    ...
    def __init__(self, state_dim: int, action_dim: int, num_policies: int):
        ...
        self.ext_q = NguDqnMlpNet(state_dim=state_dim, action_dim=action_dim, num_policies=num_policies)
        self.int_q = NguDqnMlpNet(state_dim=state_dim, action_dim=action_dim, num_policies=num_policies)
